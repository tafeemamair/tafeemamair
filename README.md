...
**Machine Learning → Applied AI → AI Agents → Tool Use → Automation → Production Systems**

---

## 🚀 Featured Projects

### [Taf's Pilot](https://github.com/tafeemamair/Tafs-Pilot)
**Autonomous AI Video Production Agent**

An autonomous agent that takes a creative brief through planning, human approval, media production, automated quality control, self-correction, and final delivery.
...
A spec-driven shopping agent that uses tool calling and deterministic deal-verification policies to distinguish a genuinely verified cheapest offer from an apparently cheaper offer with unverified mandatory charges.
...
My current AI work is built on a foundation in **Data Science, Machine Learning, Deep Learning, analytics, and predictive modeling**.
...
I'm focused on building practical AI systems that combine:

**LLMs + Agents + Tools + Automation + APIs + Deterministic Logic**
...
- Google ADK & Gemini
- Amazon Strands Agents SDK & Amazon Bedrock
- Workflow automation with Zapier and n8n
- API-driven automation
- Production AI architecture
- Reliable AI systems with verification and guardrails

---

## 🎯 What I'm Building Toward

I want to build AI systems that don't just **generate answers** — they **reason, use tools, execute workflows, verify results, and deliver useful outcomes**.

My goal is to combine strong ML fundamentals with modern AI engineering to turn real-world problems into reliable, usable systems.

---

## 📌 Portfolio

Explore my work across **AI agents, automation, machine learning, and production applications** through my repositories and portfolio projects.
